# -*- coding: utf-8 -*-
"""research/quality/member_bands.py — 21 位 swing 板成员的"波段档"子线（与 comparison_all 同源重算）。

成员宇宙 = PANELS["swing"] 21 人（swing 板投综合 2/3 票的就是这批人；short 专属 9 人不出现在
...
（专项榜需要这两列）；② 波段表只在 eligible（帖子跨度≥6月 且 2026 信号>50）博主上输出，
...
MEMBERS = sorted(set(config.PANELS["swing"]))   # 21 人（swing 板；short 专属不在此投票）
